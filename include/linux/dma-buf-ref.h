...
static inline struct msm_dma_buf *msm_dma_buf_create(struct dma_buf *dma_buf) { return ERR_PTR(-ENOMEM); }
static inline void msm_dma_buf_destroy(struct dma_buf *dma_buf) {}
#endif
